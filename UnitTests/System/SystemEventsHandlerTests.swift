...
final class SystemEventsHandlerTests: XCTestCase {
    ...
    var interactors: DependencyInjectionContainer.Interactors {
    ...
    func setupSut(countries: [MockedCountriesInteractor.Action] = [],
        ...
        let interactors = DependencyInjectionContainer.Interactors(
        ...
        let container = DependencyInjectionContainer(appState: AppState(),
